...
import { CanAccessMessagePage, CanAccessMessagePageAsync, GetPositionName } from '@/utils/utility';
        ...
        if (typeof window !== 'undefined') {
            ...
            const handleMessage = async () => {
                try {
                    ...
                    const canAccess = await CanAccessMessagePageAsync('view', uid, currentUserUID)
                    if (!canAccess) {
